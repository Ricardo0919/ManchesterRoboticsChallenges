...
class DCMotor(Node):
    def __init__(self):
        ...
        # Agregar un publicador para el tópico de control de la simulación
        self.control_pub = self.create_publisher(Bool, 'simulation_control', 10)
    ...
    #Timer Callback
    def timer_cb(self):
        #While simulation is not running stop processing
    ...
    def simulation_service_callback(self, request, response):
        ...
        # Publicar el estado de la simulación
        control_msg = Bool()
